...
internal sealed class RefreshTokenExchangeService(
    IClientInfoService clientInfoService,
    IPersonsRepository personRepository,
    IRefreshTokenService refreshTokenService,
    IJwtTokenService jwtTokenService,
    ILogger<RefreshTokenExchangeService> logger)
    : IRefreshTokenExchangeService
{
    private const string ServiceName = "[RefreshTokenExchangeService]";
