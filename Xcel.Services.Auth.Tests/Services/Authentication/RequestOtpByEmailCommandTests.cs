...
public class RequestOtpByEmailCommandTests : AuthBaseTest
{
    ...
    public async Task RequestOtpByEmailAsync_WhenPersonExists_ShouldSendOtp()
    {
        ...
        // Act
        var result = await RequestOtpByEmailCommand.RequestOtpByEmailAsync(person.EmailAddress);
    ...
    public async Task RequestOtpByEmailAsync_WhenPersonNotFound_ShouldFail()
    {
        ...
        // Act
        var result = await RequestOtpByEmailCommand.RequestOtpByEmailAsync(unknownEmail);
