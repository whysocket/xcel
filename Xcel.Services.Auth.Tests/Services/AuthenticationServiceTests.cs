...
public class AuthenticationServiceTests : AuthBaseTest
{
    ...
    public async Task RefreshTokenAsync_WhenJwtGenerationFails_ShouldReturnFailure()
    {
        ...
        var mockClientInfoService = Substitute.For<IClientInfoService>();
        mockClientInfoService.PersonId.Returns(_person.Id); // Simulate the PersonId being available
    ...
    public async Task RefreshTokenAsync_WhenRefreshTokenGenerationFails_ShouldReturnFailure()
    {
        ...
        mockRefreshTokenService.RevokeRefreshTokenAsync(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(Task.FromResult(Result.Ok()));
        ...
        var mockClientInfoService = Substitute.For<IClientInfoService>();
        mockClientInfoService.PersonId.Returns(_person.Id);
