...
public class AssignRoleToPersonCommandTests : AuthBaseTest
{
    ...
    public async Task AssignRoleToPersonAsync_WhenPersonAndRoleExist_ShouldAssignRole()
    {
        ...
        // Act
        var result = await AssignRoleToPersonCommand.AssignRoleToPersonAsync(person.Id, role.Id);
    ...
    public async Task AssignRoleToPersonAsync_WhenRoleDoesNotExist_ShouldReturnFailureNotFound()
    {
        ...
        // Act
        var result = await AssignRoleToPersonCommand.AssignRoleToPersonAsync(person.Id, nonExistentRoleId);
    ...
    public async Task AssignRoleToPersonAsync_WhenInvalidPersonId_ShouldReturnFailureValidation()
    {
        ...
        // Act
        var result = await AssignRoleToPersonCommand.AssignRoleToPersonAsync(invalidGuid, Guid.NewGuid());
    ...
    public async Task AssignRoleToPersonAsync_WhenInvalidRoleId_ShouldReturnFailureValidation()
    {
        ...
        // Act
        var result = await AssignRoleToPersonCommand.AssignRoleToPersonAsync(personId, Guid.Empty);
