...
public class GetRolesForPersonServiceTests : AuthBaseTest
{
    [Fact]
    public async Task GetRolesForPersonAsync_WhenPersonHasNoRoles_ShouldReturnEmptyList()
    {
        ...
        // Act
        var result = await GetRolesForPersonService.GetRolesForPersonAsync(person.Id);
    ...
    public async Task GetRolesForPersonAsync_WhenInvalidPersonId_ShouldReturnFailureValidation()
    {
        ...
        // Act
        var result = await GetRolesForPersonService.GetRolesForPersonAsync(invalidPersonId);
