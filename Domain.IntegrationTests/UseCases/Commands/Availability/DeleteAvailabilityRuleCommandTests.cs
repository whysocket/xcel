...
public class DeleteAvailabilityRuleCommandTests : BaseTest
{
    ...
    public override async Task InitializeAsync()
    {
        ...
        _command = new DeleteAvailabilityRuleCommand(AvailabilityRulesRepository, CreateLogger<DeleteAvailabilityRuleCommand>());
    }
    ...
    {
        // Arrange
        var person = new Person { FirstName = "Deletable", LastName = "Slot", EmailAddress = "delete@xcel.com" };
        ...
        var input = new DeleteAvailabilityRuleInput(rule.Id, person.Id, AvailabilityOwnerType.Tutor);
    ...
    {
        // Arrange
        var input = new DeleteAvailabilityRuleInput(Guid.NewGuid(), Guid.NewGuid(), AvailabilityOwnerType.Reviewer);
    ...
    {
        // Arrange
        var person = new Person { FirstName = "Wrong", LastName = "User", EmailAddress = "wrong@xcel.com" };
        var other = new Person { FirstName = "Other", LastName = "Owner", EmailAddress = "owner@xcel.com" };
