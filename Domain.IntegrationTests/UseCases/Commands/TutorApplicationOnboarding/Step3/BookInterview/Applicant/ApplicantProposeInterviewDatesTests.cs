using Application.UseCases.Commands.TutorApplicationOnboarding.Step3.BookInterview.Applicant;
using Domain.Entities;
using Domain.Exceptions;
using Xcel.Services.Email.Templates;
using Xcel.TestUtils;

namespace Domain.IntegrationTests.UseCases.Commands.TutorApplicationOnboarding.Step3.BookInterview.Applicant;
