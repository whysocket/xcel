using Application.UseCases.Commands.TutorApplicationOnboarding.Step3.BookInterview.Common;
using Domain.Entities;
using Xcel.Services.Email.Templates;
using Xcel.TestUtils;

namespace Domain.IntegrationTests.UseCases.Commands.TutorApplicationOnboarding.Step3.BookInterview.Common;
