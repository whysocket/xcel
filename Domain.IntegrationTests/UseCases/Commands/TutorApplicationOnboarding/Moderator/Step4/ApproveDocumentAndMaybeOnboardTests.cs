using Application.UseCases.Commands.TutorApplicationOnboarding.Moderator.Step4;
using Domain.Entities;
using Xcel.Services.Email.Templates;
using Xcel.TestUtils;

namespace Domain.IntegrationTests.UseCases.Commands.TutorApplicationOnboarding.Moderator.Step4;
...
public class ApproveDocumentAndMaybeOnboardTests : BaseTest
{
    ...
    public async Task Handle_ApprovesFinalDocument_AndOnboardsTutor()
    {
        ...
        var createdProfile = await TutorProfilesRepository.GetByAsync(p => p.PersonId == applicant.Id);
