...
{
    public static JsonHttpResult<CustomProblemDetails> MapProblemDetails<T>(
    ...
    public static CustomProblemDetails CreateProblemDetailsFromDomainResult(
        Result result,
    ...
    private static HttpStatusCode MapStatusCode(this ErrorType errorType) =>
        errorType switch
        {
