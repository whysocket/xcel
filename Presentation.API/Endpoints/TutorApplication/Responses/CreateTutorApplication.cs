...
public record CreateRequest(
    [FromForm]
    [property: Description("Applicant's first name.")]
    string FirstName,
    [FromForm]
    [property: Description("Applicant's last name.")]
    string LastName,
    [FromForm]
    [property: Description("Applicant's email address.")]
    string EmailAddress,
    [property: Description("CV document file uploaded by the applicant.")]
    IFormFile Cv);
