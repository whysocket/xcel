...
namespace Application.UseCases.Commands.TutorApplicationOnboarding.Step4.Applicant;
...
public static class SubmitOnboardingDocument
{
    ...
    {
        return application.CurrentStep != TutorApplication.OnboardingStep.DocumentsRequested
